...
/* raw mask   */ #define GX_XF_CLIPDISABLE_DETECT_MASK                         \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_XF_CLIPDISABLE_DETECT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_CLIPDISABLE_DETECT_SHIFT 0

/* get value  */ #define GX_XF_GET_CLIPDISABLE_DETECT(reg)                     \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_XF_SET_CLIPDISABLE_DETECT(reg, x)                  \
...
/* raw mask   */ #define GX_XF_CLIPDISABLE_REJECT_MASK                         \
    (((1 << 1) - 1) << 31 - 30)
/* local mask */ #define GX_XF_CLIPDISABLE_REJECT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_CLIPDISABLE_REJECT_SHIFT 1

/* get value  */ #define GX_XF_GET_CLIPDISABLE_REJECT(reg)                     \
    GX_BITGET((reg), 30, 1)
/* set value  */ #define GX_XF_SET_CLIPDISABLE_REJECT(reg, x)                  \
...
/* raw mask   */ #define GX_XF_CLIPDISABLE_ACCEL_MASK                          \
    (((1 << 1) - 1) << 31 - 29)
/* local mask */ #define GX_XF_CLIPDISABLE_ACCEL_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_CLIPDISABLE_ACCEL_SHIFT 2

/* get value  */ #define GX_XF_GET_CLIPDISABLE_ACCEL(reg)                      \
    GX_BITGET((reg), 29, 1)
/* set value  */ #define GX_XF_SET_CLIPDISABLE_ACCEL(reg, x)                   \
...
/* set value  */ #define GX_XF_SET_PERF1_TARGET(reg, x)                        \
    ((reg) = GX_BITSET((reg), 25, 7, x))
...
/* set value  */ #define GX_XF_SET_INVERTEXSPEC_CLR(reg, x)                    \
...
/* set value  */ #define GX_XF_SET_INVERTEXSPEC_NRM(reg, x)                    \
...
/* set value  */ #define GX_XF_SET_INVERTEXSPEC_TXC(reg, x)                    \
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_MATSRC_MASK                         \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_XF_COLOR0CNTRL_MATSRC_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_MATSRC_SHIFT 0

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_MATSRC(reg)                     \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_MATSRC(reg, x)                  \
    ((reg) = GX_BITSET((reg), 31, 1, x))
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_LIGHT_MASK                          \
    (((1 << 1) - 1) << 31 - 30)
/* local mask */ #define GX_XF_COLOR0CNTRL_LIGHT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_LIGHT_SHIFT 1

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_LIGHT(reg)                      \
    GX_BITGET((reg), 30, 1)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_LIGHT(reg, x)                   \
    ((reg) = GX_BITSET((reg), 30, 1, x))
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_LMASKLO_MASK                        \
    (((1 << 4) - 1) << 31 - 29)
/* local mask */ #define GX_XF_COLOR0CNTRL_LMASKLO_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_LMASKLO_SHIFT 2

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_LMASKLO(reg)                    \
    GX_BITGET((reg), 26, 4)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_LMASKLO(reg, x)                 \
    ((reg) = GX_BITSET((reg), 26, 4, x))
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_AMBSRC_MASK                         \
    (((1 << 1) - 1) << 31 - 25)
/* local mask */ #define GX_XF_COLOR0CNTRL_AMBSRC_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_AMBSRC_SHIFT 6

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_AMBSRC(reg)                     \
    GX_BITGET((reg), 25, 1)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_AMBSRC(reg, x)                  \
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_DIFFUSEATTN_MASK                    \
    (((1 << 2) - 1) << 31 - 24)
/* local mask */ #define GX_XF_COLOR0CNTRL_DIFFUSEATTN_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_DIFFUSEATTN_SHIFT 7

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_DIFFUSEATTN(reg)                \
    GX_BITGET((reg), 23, 2)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_DIFFUSEATTN(reg, x)             \
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_ATTNENABLE_MASK                     \
    (((1 << 1) - 1) << 31 - 22)
/* local mask */ #define GX_XF_COLOR0CNTRL_ATTNENABLE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_ATTNENABLE_SHIFT 9

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_ATTNENABLE(reg)                 \
    GX_BITGET((reg), 22, 1)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_ATTNENABLE(reg, x)              \
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_ATTNSELECT_MASK                     \
    (((1 << 1) - 1) << 31 - 21)
/* local mask */ #define GX_XF_COLOR0CNTRL_ATTNSELECT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_ATTNSELECT_SHIFT 10

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_ATTNSELECT(reg)                 \
    GX_BITGET((reg), 21, 1)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_ATTNSELECT(reg, x)              \
...
/* raw mask   */ #define GX_XF_COLOR0CNTRL_LMASKHI_MASK                        \
    (((1 << 4) - 1) << 31 - 20)
/* local mask */ #define GX_XF_COLOR0CNTRL_LMASKHI_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_XF_COLOR0CNTRL_LMASKHI_SHIFT 11

/* get value  */ #define GX_XF_GET_COLOR0CNTRL_LMASKHI(reg)                    \
    GX_BITGET((reg), 17, 4)
/* set value  */ #define GX_XF_SET_COLOR0CNTRL_LMASKHI(reg, x)                 \
    ((reg) = GX_BITSET((reg), 17, 4, x))
...
/* raw mask   */ #define GX_XF_MATRIXINDEX0_GEOM_MASK                          \
    (((1 << 6) - 1) << 31 - 31)
/* local mask */ #define GX_XF_MATRIXINDEX0_GEOM_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_XF_MATRIXINDEX0_GEOM_SHIFT 0

/* get value  */ #define GX_XF_GET_MATRIXINDEX0_GEOM(reg)                      \
    GX_BITGET((reg), 26, 6)
/* set value  */ #define GX_XF_SET_MATRIXINDEX0_GEOM(reg, x)                   \
...
/* raw mask   */ #define GX_XF_MATRIXINDEX0_TEX0_MASK                          \
    (((1 << 6) - 1) << 31 - 25)
/* local mask */ #define GX_XF_MATRIXINDEX0_TEX0_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_XF_MATRIXINDEX0_TEX0_SHIFT 6

/* get value  */ #define GX_XF_GET_MATRIXINDEX0_TEX0(reg)                      \
    GX_BITGET((reg), 20, 6)
/* set value  */ #define GX_XF_SET_MATRIXINDEX0_TEX0(reg, x)                   \
...
/* raw mask   */ #define GX_XF_MATRIXINDEX0_TEX1_MASK                          \
    (((1 << 6) - 1) << 31 - 19)
/* local mask */ #define GX_XF_MATRIXINDEX0_TEX1_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_XF_MATRIXINDEX0_TEX1_SHIFT 12

/* get value  */ #define GX_XF_GET_MATRIXINDEX0_TEX1(reg)                      \
    GX_BITGET((reg), 14, 6)
/* set value  */ #define GX_XF_SET_MATRIXINDEX0_TEX1(reg, x)                   \
...
/* raw mask   */ #define GX_XF_MATRIXINDEX0_TEX2_MASK                          \
    (((1 << 6) - 1) << 31 - 13)
...
/* set value  */ #define GX_XF_SET_MATRIXINDEX0_TEX2(reg, x)                   \
...
/* set value  */ #define GX_XF_SET_MATRIXINDEX0_TEX3(reg, x)                   \
...
/* raw mask   */ #define GX_XF_MATRIXINDEX1_TEX4_MASK                          \
    (((1 << 6) - 1) << 31 - 31)
/* local mask */ #define GX_XF_MATRIXINDEX1_TEX4_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_XF_MATRIXINDEX1_TEX4_SHIFT 0

/* get value  */ #define GX_XF_GET_MATRIXINDEX1_TEX4(reg)                      \
    GX_BITGET((reg), 26, 6)
/* set value  */ #define GX_XF_SET_MATRIXINDEX1_TEX4(reg, x)                   \
    ((reg) = GX_BITSET((reg), 26, 6, x))
...
/* raw mask   */ #define GX_XF_MATRIXINDEX1_TEX5_MASK                          \
    (((1 << 6) - 1) << 31 - 25)
/* local mask */ #define GX_XF_MATRIXINDEX1_TEX5_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_XF_MATRIXINDEX1_TEX5_SHIFT 6

/* get value  */ #define GX_XF_GET_MATRIXINDEX1_TEX5(reg)                      \
    GX_BITGET((reg), 20, 6)
/* set value  */ #define GX_XF_SET_MATRIXINDEX1_TEX5(reg, x)                   \
    ((reg) = GX_BITSET((reg), 20, 6, x))
...
/* raw mask   */ #define GX_XF_MATRIXINDEX1_TEX6_MASK                          \
    (((1 << 6) - 1) << 31 - 19)
/* local mask */ #define GX_XF_MATRIXINDEX1_TEX6_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_XF_MATRIXINDEX1_TEX6_SHIFT 12

/* get value  */ #define GX_XF_GET_MATRIXINDEX1_TEX6(reg)                      \
    GX_BITGET((reg), 14, 6)
/* set value  */ #define GX_XF_SET_MATRIXINDEX1_TEX6(reg, x)                   \
    ((reg) = GX_BITSET((reg), 14, 6, x))
...
/* raw mask   */ #define GX_XF_MATRIXINDEX1_TEX7_MASK                          \
    (((1 << 6) - 1) << 31 - 13)
...
/* set value  */ #define GX_XF_SET_MATRIXINDEX1_TEX7(reg, x)                   \
    ((reg) = GX_BITSET((reg), 8, 6, x))
...
/* set value  */ #define GX_XF_SET_TEX_PROJTYPE(reg, x)                        \
    ((reg) = GX_BITSET((reg), 30, 1, x))
...
/* set value  */ #define GX_XF_SET_TEX_INPUTFORM(reg, x)                       \
    ((reg) = GX_BITSET((reg), 29, 1, x))
...
/* set value  */ #define GX_XF_SET_TEX_TEXGENTYPE(reg, x)                      \
...
/* set value  */ #define GX_XF_SET_TEX_SRCROW(reg, x)                          \
    ((reg) = GX_BITSET((reg), 20, 5, x))
...
/* set value  */ #define GX_XF_SET_TEX_BUMPSRCTEX(reg, x)                      \
...
/* set value  */ #define GX_XF_SET_TEX_BUMPSRCLIGHT(reg, x)                    \
...
/* set value  */ #define GX_XF_SET_DUALTEX_BASEROW(reg, x)                     \
    ((reg) = GX_BITSET((reg), 26, 6, x))
...
/* raw mask   */ #define GX_XF_DUALTEX_NORMALIZE_MASK                          \
    (((1 << 1) - 1) << 31 - 23)
/* local mask */ #define GX_XF_DUALTEX_NORMALIZE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_XF_DUALTEX_NORMALIZE_SHIFT 8

/* get value  */ #define GX_XF_GET_DUALTEX_NORMALIZE(reg)                      \
    GX_BITGET((reg), 23, 1)
/* set value  */ #define GX_XF_SET_DUALTEX_NORMALIZE(reg, x)                   \
