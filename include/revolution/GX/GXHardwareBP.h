...
/* set value  */ #define GX_BP_SET_GENMODE_NUMTEX(reg, x)                      \
    ((reg) = GX_BITSET((reg), 28, 4, x))
...
/* raw mask   */ #define GX_BP_GENMODE_NUMCOLORS_MASK                          \
    (((1 << 3) - 1) << 31 - 27)
/* local mask */ #define GX_BP_GENMODE_NUMCOLORS_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_GENMODE_NUMCOLORS_SHIFT 4

/* get value  */ #define GX_BP_GET_GENMODE_NUMCOLORS(reg)                      \
    GX_BITGET((reg), 25, 3)
/* set value  */ #define GX_BP_SET_GENMODE_NUMCOLORS(reg, x)                   \
    ((reg) = GX_BITSET((reg), 25, 3, x))
...
/* raw mask   */ #define GX_BP_GENMODE_MULTISAMPLE_MASK                        \
    (((1 << 1) - 1) << 31 - 22)
/* local mask */ #define GX_BP_GENMODE_MULTISAMPLE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_GENMODE_MULTISAMPLE_SHIFT 9

/* get value  */ #define GX_BP_GET_GENMODE_MULTISAMPLE(reg)                    \
    GX_BITGET((reg), 22, 1)
/* set value  */ #define GX_BP_SET_GENMODE_MULTISAMPLE(reg, x)                 \
...
/* raw mask   */ #define GX_BP_GENMODE_NUMTEVSTAGES_MASK                       \
    (((1 << 4) - 1) << 31 - 21)
/* local mask */ #define GX_BP_GENMODE_NUMTEVSTAGES_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_BP_GENMODE_NUMTEVSTAGES_SHIFT 10

/* get value  */ #define GX_BP_GET_GENMODE_NUMTEVSTAGES(reg)                   \
    GX_BITGET((reg), 18, 4)
/* set value  */ #define GX_BP_SET_GENMODE_NUMTEVSTAGES(reg, x)                \
    ((reg) = GX_BITSET((reg), 18, 4, x))
...
/* set value  */ #define GX_BP_SET_GENMODE_CULLMODE(reg, x)                    \
    ((reg) = GX_BITSET((reg), 16, 2, x))
...
/* raw mask   */ #define GX_BP_GENMODE_NUMINDSTAGES_MASK                       \
    (((1 << 3) - 1) << 31 - 15)
/* local mask */ #define GX_BP_GENMODE_NUMINDSTAGES_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_GENMODE_NUMINDSTAGES_SHIFT 16

/* get value  */ #define GX_BP_GET_GENMODE_NUMINDSTAGES(reg)                   \
    GX_BITGET((reg), 13, 3)
/* set value  */ #define GX_BP_SET_GENMODE_NUMINDSTAGES(reg, x)                \
...
/* set value  */ #define GX_BP_SET_GENMODE_COPLANAR(reg, x)                    \
...
/* set value  */ #define GX_BP_SET_INDMTXA_M00(reg, x)                         \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_INDMTXA_M10(reg, x)                         \
    ((reg) = GX_BITSET((reg), 10, 11, x))
...
/* set value  */ #define GX_BP_SET_INDMTXA_EXP(reg, x)                         \
    ((reg) = GX_BITSET((reg), 8, 2, x))
...
/* set value  */ #define GX_BP_SET_INDMTXB_M01(reg, x)                         \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_INDMTXB_M11(reg, x)                         \
    ((reg) = GX_BITSET((reg), 10, 11, x))
...
/* set value  */ #define GX_BP_SET_INDMTXB_EXP(reg, x)                         \
    ((reg) = GX_BITSET((reg), 8, 2, x))
...
/* set value  */ #define GX_BP_SET_INDMTXC_M02(reg, x)                         \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_INDMTXC_M12(reg, x)                         \
    ((reg) = GX_BITSET((reg), 10, 11, x))
...
/* set value  */ #define GX_BP_SET_INDMTXC_EXP(reg, x)                         \
    ((reg) = GX_BITSET((reg), 8, 2, x))
...
/* set value  */ #define GX_BP_SET_INDIMASK_IMASK(reg, x)                      \
    ((reg) = GX_BITSET((reg), 24, 8, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_STAGE_MASK                          \
    (((1 << 2) - 1) << 31 - 31)
/* local mask */ #define GX_BP_INDTEVSTAGE_STAGE_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_STAGE_SHIFT 0

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_STAGE(reg)                      \
    GX_BITGET((reg), 30, 2)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_STAGE(reg, x)                   \
    ((reg) = GX_BITSET((reg), 30, 2, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_FORMAT_MASK                         \
    (((1 << 2) - 1) << 31 - 29)
/* local mask */ #define GX_BP_INDTEVSTAGE_FORMAT_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_FORMAT_SHIFT 2

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_FORMAT(reg)                     \
    GX_BITGET((reg), 28, 2)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_FORMAT(reg, x)                  \
    ((reg) = GX_BITSET((reg), 28, 2, x))
...
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_BIAS(reg, x)                    \
    ((reg) = GX_BITSET((reg), 25, 3, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_ALPHA_MASK                          \
    (((1 << 2) - 1) << 31 - 24)
/* local mask */ #define GX_BP_INDTEVSTAGE_ALPHA_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_ALPHA_SHIFT 7

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_ALPHA(reg)                      \
    GX_BITGET((reg), 23, 2)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_ALPHA(reg, x)                   \
...
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_MTX(reg, x)                     \
    ((reg) = GX_BITSET((reg), 19, 4, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_WRAPS_MASK                          \
    (((1 << 3) - 1) << 31 - 18)
/* local mask */ #define GX_BP_INDTEVSTAGE_WRAPS_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_WRAPS_SHIFT 13

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_WRAPS(reg)                      \
    GX_BITGET((reg), 16, 3)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_WRAPS(reg, x)                   \
    ((reg) = GX_BITSET((reg), 16, 3, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_WRAPT_MASK                          \
    (((1 << 3) - 1) << 31 - 15)
/* local mask */ #define GX_BP_INDTEVSTAGE_WRAPT_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_WRAPT_SHIFT 16

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_WRAPT(reg)                      \
    GX_BITGET((reg), 13, 3)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_WRAPT(reg, x)                   \
    ((reg) = GX_BITSET((reg), 13, 3, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_UTCLOD_MASK                         \
    (((1 << 1) - 1) << 31 - 12)
/* local mask */ #define GX_BP_INDTEVSTAGE_UTCLOD_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_UTCLOD_SHIFT 19

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_UTCLOD(reg)                     \
    GX_BITGET((reg), 12, 1)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_UTCLOD(reg, x)                  \
    ((reg) = GX_BITSET((reg), 12, 1, x))
...
/* raw mask   */ #define GX_BP_INDTEVSTAGE_ADDPREV_MASK                        \
    (((1 << 1) - 1) << 31 - 11)
/* local mask */ #define GX_BP_INDTEVSTAGE_ADDPREV_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_INDTEVSTAGE_ADDPREV_SHIFT 20

/* get value  */ #define GX_BP_GET_INDTEVSTAGE_ADDPREV(reg)                    \
    GX_BITGET((reg), 11, 1)
/* set value  */ #define GX_BP_SET_INDTEVSTAGE_ADDPREV(reg, x)                 \
...
/* set value  */ #define GX_BP_SET_SCISSORTL_TOP(reg, x)                       \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_SCISSORTL_LEFT(reg, x)                      \
    ((reg) = GX_BITSET((reg), 9, 11, x))
...
/* set value  */ #define GX_BP_SET_SCISSORBR_BOT(reg, x)                       \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_SCISSORBR_RIGHT(reg, x)                     \
    ((reg) = GX_BITSET((reg), 9, 11, x))
...
/* raw mask   */ #define GX_BP_LINEPTWIDTH_LINESZ_MASK                         \
    (((1 << 8) - 1) << 31 - 31)
/* local mask */ #define GX_BP_LINEPTWIDTH_LINESZ_LMASK ((1 << 8) - 1)
/* bit shift  */ #define GX_BP_LINEPTWIDTH_LINESZ_SHIFT 0

/* get value  */ #define GX_BP_GET_LINEPTWIDTH_LINESZ(reg)                     \
    GX_BITGET((reg), 24, 8)
/* set value  */ #define GX_BP_SET_LINEPTWIDTH_LINESZ(reg, x)                  \
    ((reg) = GX_BITSET((reg), 24, 8, x))
...
/* raw mask   */ #define GX_BP_LINEPTWIDTH_POINTSZ_MASK                        \
    (((1 << 8) - 1) << 31 - 23)
/* local mask */ #define GX_BP_LINEPTWIDTH_POINTSZ_LMASK ((1 << 8) - 1)
/* bit shift  */ #define GX_BP_LINEPTWIDTH_POINTSZ_SHIFT 8

/* get value  */ #define GX_BP_GET_LINEPTWIDTH_POINTSZ(reg)                    \
    GX_BITGET((reg), 16, 8)
/* set value  */ #define GX_BP_SET_LINEPTWIDTH_POINTSZ(reg, x)                 \
    ((reg) = GX_BITSET((reg), 16, 8, x))
...
/* raw mask   */ #define GX_BP_LINEPTWIDTH_LINEOFS_MASK                        \
    (((1 << 3) - 1) << 31 - 15)
/* local mask */ #define GX_BP_LINEPTWIDTH_LINEOFS_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_LINEPTWIDTH_LINEOFS_SHIFT 16

/* get value  */ #define GX_BP_GET_LINEPTWIDTH_LINEOFS(reg)                    \
    GX_BITGET((reg), 13, 3)
/* set value  */ #define GX_BP_SET_LINEPTWIDTH_LINEOFS(reg, x)                 \
    ((reg) = GX_BITSET((reg), 13, 3, x))
...
/* raw mask   */ #define GX_BP_LINEPTWIDTH_POINTOFS_MASK                       \
    (((1 << 3) - 1) << 31 - 12)
/* local mask */ #define GX_BP_LINEPTWIDTH_POINTOFS_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_LINEPTWIDTH_POINTOFS_SHIFT 19

/* get value  */ #define GX_BP_GET_LINEPTWIDTH_POINTOFS(reg)                   \
    GX_BITGET((reg), 10, 3)
/* set value  */ #define GX_BP_SET_LINEPTWIDTH_POINTOFS(reg, x)                \
...
/* raw mask   */ #define GX_BP_LINEPTWIDTH_ADJUST_AR_MASK                      \
    (((1 << 1) - 1) << 31 - 9)
/* local mask */ #define GX_BP_LINEPTWIDTH_ADJUST_AR_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_LINEPTWIDTH_ADJUST_AR_SHIFT 22

/* get value  */ #define GX_BP_GET_LINEPTWIDTH_ADJUST_AR(reg)                  \
    GX_BITGET((reg), 9, 1)
/* set value  */ #define GX_BP_SET_LINEPTWIDTH_ADJUST_AR(reg, x)               \
...
/* set value  */ #define GX_BP_SET_RAS1_SS0_S0(reg, x)                         \
    ((reg) = GX_BITSET((reg), 28, 4, x))
...
/* set value  */ #define GX_BP_SET_RAS1_SS0_T0(reg, x)                         \
...
/* set value  */ #define GX_BP_SET_RAS1_SS0_S1(reg, x)                         \
    ((reg) = GX_BITSET((reg), 20, 4, x))
...
/* set value  */ #define GX_BP_SET_RAS1_SS0_T1(reg, x)                         \
...
/* set value  */ #define GX_BP_SET_RAS1_SS1_S2(reg, x)                         \
    ((reg) = GX_BITSET((reg), 28, 4, x))
...
/* set value  */ #define GX_BP_SET_RAS1_SS1_T2(reg, x)                         \
    ((reg) = GX_BITSET((reg), 24, 4, x))
...
/* set value  */ #define GX_BP_SET_RAS1_SS1_S3(reg, x)                         \
    ((reg) = GX_BITSET((reg), 20, 4, x))
...
/* set value  */ #define GX_BP_SET_RAS1_SS1_T3(reg, x)                         \
    ((reg) = GX_BITSET((reg), 16, 4, x))
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_MAP0(reg, x)                      \
    ((reg) = GX_BITSET((reg), 29, 3, x))
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_TXC0(reg, x)                      \
    ((reg) = GX_BITSET((reg), 26, 3, x))
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_MAP1(reg, x)                      \
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_TXC1(reg, x)                      \
    ((reg) = GX_BITSET((reg), 20, 3, x))
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_MAP2(reg, x)                      \
    ((reg) = GX_BITSET((reg), 17, 3, x))
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_TXC2(reg, x)                      \
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_MAP3(reg, x)                      \
...
/* set value  */ #define GX_BP_SET_RAS1_IREF_TXC3(reg, x)                      \
    ((reg) = GX_BITSET((reg), 8, 3, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_TEXMAP_EVEN_MASK                      \
    (((1 << 3) - 1) << 31 - 31)
/* local mask */ #define GX_BP_RAS1_TREF_TEXMAP_EVEN_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_TEXMAP_EVEN_SHIFT 0

/* get value  */ #define GX_BP_GET_RAS1_TREF_TEXMAP_EVEN(reg)                  \
    GX_BITGET((reg), 29, 3)
/* set value  */ #define GX_BP_SET_RAS1_TREF_TEXMAP_EVEN(reg, x)               \
    ((reg) = GX_BITSET((reg), 29, 3, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_TEXCOORD_EVEN_MASK                    \
    (((1 << 3) - 1) << 31 - 28)
/* local mask */ #define GX_BP_RAS1_TREF_TEXCOORD_EVEN_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_TEXCOORD_EVEN_SHIFT 3

/* get value  */ #define GX_BP_GET_RAS1_TREF_TEXCOORD_EVEN(reg)                \
    GX_BITGET((reg), 26, 3)
/* set value  */ #define GX_BP_SET_RAS1_TREF_TEXCOORD_EVEN(reg, x)             \
    ((reg) = GX_BITSET((reg), 26, 3, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_ENABLE_TEX_EVEN_MASK                  \
    (((1 << 1) - 1) << 31 - 25)
/* local mask */ #define GX_BP_RAS1_TREF_ENABLE_TEX_EVEN_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_ENABLE_TEX_EVEN_SHIFT 6

/* get value  */ #define GX_BP_GET_RAS1_TREF_ENABLE_TEX_EVEN(reg)              \
    GX_BITGET((reg), 25, 1)
/* set value  */ #define GX_BP_SET_RAS1_TREF_ENABLE_TEX_EVEN(reg, x)           \
    ((reg) = GX_BITSET((reg), 25, 1, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_COLORCHAN_EVEN_MASK                   \
    (((1 << 3) - 1) << 31 - 24)
/* local mask */ #define GX_BP_RAS1_TREF_COLORCHAN_EVEN_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_COLORCHAN_EVEN_SHIFT 7

/* get value  */ #define GX_BP_GET_RAS1_TREF_COLORCHAN_EVEN(reg)               \
    GX_BITGET((reg), 22, 3)
/* set value  */ #define GX_BP_SET_RAS1_TREF_COLORCHAN_EVEN(reg, x)            \
    ((reg) = GX_BITSET((reg), 22, 3, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_TEXMAP_ODD_MASK                       \
    (((1 << 3) - 1) << 31 - 19)
/* local mask */ #define GX_BP_RAS1_TREF_TEXMAP_ODD_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_TEXMAP_ODD_SHIFT 12

/* get value  */ #define GX_BP_GET_RAS1_TREF_TEXMAP_ODD(reg)                   \
    GX_BITGET((reg), 17, 3)
/* set value  */ #define GX_BP_SET_RAS1_TREF_TEXMAP_ODD(reg, x)                \
    ((reg) = GX_BITSET((reg), 17, 3, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_TEXCOORD_ODD_MASK                     \
    (((1 << 3) - 1) << 31 - 16)
/* local mask */ #define GX_BP_RAS1_TREF_TEXCOORD_ODD_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_TEXCOORD_ODD_SHIFT 15

/* get value  */ #define GX_BP_GET_RAS1_TREF_TEXCOORD_ODD(reg)                 \
    GX_BITGET((reg), 14, 3)
/* set value  */ #define GX_BP_SET_RAS1_TREF_TEXCOORD_ODD(reg, x)              \
    ((reg) = GX_BITSET((reg), 14, 3, x))
...
/* raw mask   */ #define GX_BP_RAS1_TREF_ENABLE_TEX_ODD_MASK                   \
    (((1 << 1) - 1) << 31 - 13)
/* local mask */ #define GX_BP_RAS1_TREF_ENABLE_TEX_ODD_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_ENABLE_TEX_ODD_SHIFT 18

/* get value  */ #define GX_BP_GET_RAS1_TREF_ENABLE_TEX_ODD(reg)               \
    GX_BITGET((reg), 13, 1)
/* set value  */ #define GX_BP_SET_RAS1_TREF_ENABLE_TEX_ODD(reg, x)            \
...
/* raw mask   */ #define GX_BP_RAS1_TREF_COLORCHAN_ODD_MASK                    \
    (((1 << 3) - 1) << 31 - 12)
/* local mask */ #define GX_BP_RAS1_TREF_COLORCHAN_ODD_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_RAS1_TREF_COLORCHAN_ODD_SHIFT 19

/* get value  */ #define GX_BP_GET_RAS1_TREF_COLORCHAN_ODD(reg)                \
    GX_BITGET((reg), 10, 3)
/* set value  */ #define GX_BP_SET_RAS1_TREF_COLORCHAN_ODD(reg, x)             \
    ((reg) = GX_BITSET((reg), 10, 3, x))
...
/* set value  */ #define GX_BP_SET_SU_SIZE_SCALE(reg, x)                       \
    ((reg) = GX_BITSET((reg), 16, 16, x))
...
/* raw mask   */ #define GX_BP_SU_SIZE_RANGEBIAS_MASK                          \
    (((1 << 1) - 1) << 31 - 15)
/* local mask */ #define GX_BP_SU_SIZE_RANGEBIAS_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_SU_SIZE_RANGEBIAS_SHIFT 16

/* get value  */ #define GX_BP_GET_SU_SIZE_RANGEBIAS(reg)                      \
    GX_BITGET((reg), 15, 1)
/* set value  */ #define GX_BP_SET_SU_SIZE_RANGEBIAS(reg, x)                   \
    ((reg) = GX_BITSET((reg), 15, 1, x))
...
/* raw mask   */ #define GX_BP_SU_SIZE_CYLINDRICWRAP_MASK                      \
    (((1 << 1) - 1) << 31 - 14)
/* local mask */ #define GX_BP_SU_SIZE_CYLINDRICWRAP_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_SU_SIZE_CYLINDRICWRAP_SHIFT 17

/* get value  */ #define GX_BP_GET_SU_SIZE_CYLINDRICWRAP(reg)                  \
    GX_BITGET((reg), 14, 1)
/* set value  */ #define GX_BP_SET_SU_SIZE_CYLINDRICWRAP(reg, x)               \
...
/* raw mask   */ #define GX_BP_SU_SIZE_USELINEOFS_MASK                         \
    (((1 << 1) - 1) << 31 - 13)
/* local mask */ #define GX_BP_SU_SIZE_USELINEOFS_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_SU_SIZE_USELINEOFS_SHIFT 18

/* get value  */ #define GX_BP_GET_SU_SIZE_USELINEOFS(reg)                     \
    GX_BITGET((reg), 13, 1)
/* set value  */ #define GX_BP_SET_SU_SIZE_USELINEOFS(reg, x)                  \
    ((reg) = GX_BITSET((reg), 13, 1, x))
...
/* raw mask   */ #define GX_BP_SU_SIZE_USEPOINTOFS_MASK                        \
    (((1 << 1) - 1) << 31 - 12)
/* local mask */ #define GX_BP_SU_SIZE_USEPOINTOFS_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_SU_SIZE_USEPOINTOFS_SHIFT 19

/* get value  */ #define GX_BP_GET_SU_SIZE_USEPOINTOFS(reg)                    \
    GX_BITGET((reg), 12, 1)
/* set value  */ #define GX_BP_SET_SU_SIZE_USEPOINTOFS(reg, x)                 \
    ((reg) = GX_BITSET((reg), 12, 1, x))
...
/* raw mask   */ #define GX_BP_ZMODE_TEST_ENABLE_MASK                          \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_BP_ZMODE_TEST_ENABLE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_ZMODE_TEST_ENABLE_SHIFT 0

/* get value  */ #define GX_BP_GET_ZMODE_TEST_ENABLE(reg)                      \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_BP_SET_ZMODE_TEST_ENABLE(reg, x)                   \
...
/* set value  */ #define GX_BP_SET_ZMODE_COMPARE(reg, x)                       \
...
/* raw mask   */ #define GX_BP_ZMODE_UPDATE_ENABLE_MASK                        \
    (((1 << 1) - 1) << 31 - 27)
/* local mask */ #define GX_BP_ZMODE_UPDATE_ENABLE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_ZMODE_UPDATE_ENABLE_SHIFT 4

/* get value  */ #define GX_BP_GET_ZMODE_UPDATE_ENABLE(reg)                    \
    GX_BITGET((reg), 27, 1)
/* set value  */ #define GX_BP_SET_ZMODE_UPDATE_ENABLE(reg, x)                 \
...
/* raw mask   */ #define GX_BP_BLENDMODE_BLEND_ENABLE_MASK                     \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_BP_BLENDMODE_BLEND_ENABLE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_BLEND_ENABLE_SHIFT 0

/* get value  */ #define GX_BP_GET_BLENDMODE_BLEND_ENABLE(reg)                 \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_BP_SET_BLENDMODE_BLEND_ENABLE(reg, x)              \
    ((reg) = GX_BITSET((reg), 31, 1, x))
...
/* raw mask   */ #define GX_BP_BLENDMODE_LOGIC_OP_ENABLE_MASK                  \
    (((1 << 1) - 1) << 31 - 30)
/* local mask */ #define GX_BP_BLENDMODE_LOGIC_OP_ENABLE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_LOGIC_OP_ENABLE_SHIFT 1

/* get value  */ #define GX_BP_GET_BLENDMODE_LOGIC_OP_ENABLE(reg)              \
    GX_BITGET((reg), 30, 1)
/* set value  */ #define GX_BP_SET_BLENDMODE_LOGIC_OP_ENABLE(reg, x)           \
...
/* set value  */ #define GX_BP_SET_BLENDMODE_DITHER(reg, x)                    \
    ((reg) = GX_BITSET((reg), 29, 1, x))
...
/* raw mask   */ #define GX_BP_BLENDMODE_COLOR_UPDATE_MASK                     \
    (((1 << 1) - 1) << 31 - 28)
/* local mask */ #define GX_BP_BLENDMODE_COLOR_UPDATE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_COLOR_UPDATE_SHIFT 3

/* get value  */ #define GX_BP_GET_BLENDMODE_COLOR_UPDATE(reg)                 \
    GX_BITGET((reg), 28, 1)
/* set value  */ #define GX_BP_SET_BLENDMODE_COLOR_UPDATE(reg, x)              \
...
/* raw mask   */ #define GX_BP_BLENDMODE_ALPHA_UPDATE_MASK                     \
    (((1 << 1) - 1) << 31 - 27)
/* local mask */ #define GX_BP_BLENDMODE_ALPHA_UPDATE_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_ALPHA_UPDATE_SHIFT 4

/* get value  */ #define GX_BP_GET_BLENDMODE_ALPHA_UPDATE(reg)                 \
    GX_BITGET((reg), 27, 1)
/* set value  */ #define GX_BP_SET_BLENDMODE_ALPHA_UPDATE(reg, x)              \
    ((reg) = GX_BITSET((reg), 27, 1, x))
...
/* raw mask   */ #define GX_BP_BLENDMODE_DST_FACTOR_MASK                       \
    (((1 << 3) - 1) << 31 - 26)
/* local mask */ #define GX_BP_BLENDMODE_DST_FACTOR_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_DST_FACTOR_SHIFT 5

/* get value  */ #define GX_BP_GET_BLENDMODE_DST_FACTOR(reg)                   \
    GX_BITGET((reg), 24, 3)
/* set value  */ #define GX_BP_SET_BLENDMODE_DST_FACTOR(reg, x)                \
...
/* raw mask   */ #define GX_BP_BLENDMODE_SRC_FACTOR_MASK                       \
    (((1 << 3) - 1) << 31 - 23)
/* local mask */ #define GX_BP_BLENDMODE_SRC_FACTOR_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_SRC_FACTOR_SHIFT 8

/* get value  */ #define GX_BP_GET_BLENDMODE_SRC_FACTOR(reg)                   \
    GX_BITGET((reg), 21, 3)
/* set value  */ #define GX_BP_SET_BLENDMODE_SRC_FACTOR(reg, x)                \
...
/* raw mask   */ #define GX_BP_BLENDMODE_SUBTRACT_MASK                         \
    (((1 << 1) - 1) << 31 - 20)
/* local mask */ #define GX_BP_BLENDMODE_SUBTRACT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_SUBTRACT_SHIFT 11

/* get value  */ #define GX_BP_GET_BLENDMODE_SUBTRACT(reg)                     \
    GX_BITGET((reg), 20, 1)
/* set value  */ #define GX_BP_SET_BLENDMODE_SUBTRACT(reg, x)                  \
    ((reg) = GX_BITSET((reg), 20, 1, x))
...
/* raw mask   */ #define GX_BP_BLENDMODE_LOGIC_MODE_MASK                       \
    (((1 << 4) - 1) << 31 - 19)
/* local mask */ #define GX_BP_BLENDMODE_LOGIC_MODE_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_BP_BLENDMODE_LOGIC_MODE_SHIFT 12

/* get value  */ #define GX_BP_GET_BLENDMODE_LOGIC_MODE(reg)                   \
    GX_BITGET((reg), 16, 4)
/* set value  */ #define GX_BP_SET_BLENDMODE_LOGIC_MODE(reg, x)                \
    ((reg) = GX_BITSET((reg), 16, 4, x))
...
/* set value  */ #define GX_BP_SET_DSTALPHA_ALPHA(reg, x)                      \
    ((reg) = GX_BITSET((reg), 24, 8, x))
...
/* set value  */ #define GX_BP_SET_DSTALPHA_ENABLE(reg, x)                     \
    ((reg) = GX_BITSET((reg), 23, 1, x))
...
/* set value  */ #define GX_BP_SET_DSTALPHA_YUV_FMT(reg, x)                    \
    ((reg) = GX_BITSET((reg), 21, 2, x))
...
/* raw mask   */ #define GX_BP_ZCONTROL_PIXEL_FMT_MASK                         \
    (((1 << 3) - 1) << 31 - 31)
/* local mask */ #define GX_BP_ZCONTROL_PIXEL_FMT_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_ZCONTROL_PIXEL_FMT_SHIFT 0

/* get value  */ #define GX_BP_GET_ZCONTROL_PIXEL_FMT(reg)                     \
    GX_BITGET((reg), 29, 3)
/* set value  */ #define GX_BP_SET_ZCONTROL_PIXEL_FMT(reg, x)                  \
    ((reg) = GX_BITSET((reg), 29, 3, x))
...
/* set value  */ #define GX_BP_SET_ZCONTROL_Z_FMT(reg, x)                      \
    ((reg) = GX_BITSET((reg), 26, 3, x))
...
/* raw mask   */ #define GX_BP_ZCONTROL_BEFORE_TEX_MASK                        \
    (((1 << 1) - 1) << 31 - 25)
/* local mask */ #define GX_BP_ZCONTROL_BEFORE_TEX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_ZCONTROL_BEFORE_TEX_SHIFT 6

/* get value  */ #define GX_BP_GET_ZCONTROL_BEFORE_TEX(reg)                    \
    GX_BITGET((reg), 25, 1)
/* set value  */ #define GX_BP_SET_ZCONTROL_BEFORE_TEX(reg, x)                 \
    ((reg) = GX_BITSET((reg), 25, 1, x))
...
/* set value  */ #define GX_BP_SET_FIELDMASK_ODD(reg, x)                       \
    ((reg) = GX_BITSET((reg), 31, 1, x))
...
/* set value  */ #define GX_BP_SET_FIELDMASK_EVEN(reg, x)                      \
    ((reg) = GX_BITSET((reg), 30, 1, x))
...
/* raw mask   */ #define GX_BP_SCISSOROFFSET_OX_MASK                           \
    (((1 << 10) - 1) << 31 - 31)
/* local mask */ #define GX_BP_SCISSOROFFSET_OX_LMASK ((1 << 10) - 1)
/* bit shift  */ #define GX_BP_SCISSOROFFSET_OX_SHIFT 0

/* get value  */ #define GX_BP_GET_SCISSOROFFSET_OX(reg)                       \
    GX_BITGET((reg), 22, 10)
/* set value  */ #define GX_BP_SET_SCISSOROFFSET_OX(reg, x)                    \
...
/* raw mask   */ #define GX_BP_SCISSOROFFSET_OY_MASK                           \
    (((1 << 10) - 1) << 31 - 21)
/* local mask */ #define GX_BP_SCISSOROFFSET_OY_LMASK ((1 << 10) - 1)
/* bit shift  */ #define GX_BP_SCISSOROFFSET_OY_SHIFT 10

/* get value  */ #define GX_BP_GET_SCISSOROFFSET_OY(reg)                       \
    GX_BITGET((reg), 12, 10)
/* set value  */ #define GX_BP_SET_SCISSOROFFSET_OY(reg, x)                    \
    ((reg) = GX_BITSET((reg), 12, 10, x))
...
/* raw mask   */ #define GX_BP_FIELDMODE_TEX_LOD_MASK                          \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_BP_FIELDMODE_TEX_LOD_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_FIELDMODE_TEX_LOD_SHIFT 0

/* get value  */ #define GX_BP_GET_FIELDMODE_TEX_LOD(reg)                      \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_BP_SET_FIELDMODE_TEX_LOD(reg, x)                   \
    ((reg) = GX_BITSET((reg), 31, 1, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_D_MASK                         \
    (((1 << 4) - 1) << 31 - 31)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_D_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_D_SHIFT 0

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_D(reg)                     \
    GX_BITGET((reg), 28, 4)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_D(reg, x)                  \
    ((reg) = GX_BITSET((reg), 28, 4, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_C_MASK                         \
    (((1 << 4) - 1) << 31 - 27)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_C_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_C_SHIFT 4

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_C(reg)                     \
    GX_BITGET((reg), 24, 4)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_C(reg, x)                  \
    ((reg) = GX_BITSET((reg), 24, 4, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_B_MASK                         \
    (((1 << 4) - 1) << 31 - 23)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_B_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_B_SHIFT 8

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_B(reg)                     \
    GX_BITGET((reg), 20, 4)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_B(reg, x)                  \
    ((reg) = GX_BITSET((reg), 20, 4, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_A_MASK                         \
    (((1 << 4) - 1) << 31 - 19)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_A_LMASK ((1 << 4) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_A_SHIFT 12

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_A(reg)                     \
    GX_BITGET((reg), 16, 4)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_A(reg, x)                  \
    ((reg) = GX_BITSET((reg), 16, 4, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_BIAS_MASK                      \
    (((1 << 2) - 1) << 31 - 15)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_BIAS_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_BIAS_SHIFT 16

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_BIAS(reg)                  \
    GX_BITGET((reg), 14, 2)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_BIAS(reg, x)               \
    ((reg) = GX_BITSET((reg), 14, 2, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_OP_OR_COMPARISON_MASK          \
    (((1 << 1) - 1) << 31 - 13)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_OP_OR_COMPARISON_LMASK         \
    ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_OP_OR_COMPARISON_SHIFT 18

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_OP_OR_COMPARISON(reg)      \
    GX_BITGET((reg), 13, 1)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_OP_OR_COMPARISON(reg, x)   \
    ((reg) = GX_BITSET((reg), 13, 1, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_CLAMP_MASK                     \
    (((1 << 1) - 1) << 31 - 12)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_CLAMP_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_CLAMP_SHIFT 19

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_CLAMP(reg)                 \
    GX_BITGET((reg), 12, 1)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_CLAMP(reg, x)              \
    ((reg) = GX_BITSET((reg), 12, 1, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_SCALE_OR_COMPARE_MODE_MASK     \
    (((1 << 2) - 1) << 31 - 11)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_SCALE_OR_COMPARE_MODE_LMASK    \
    ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_SCALE_OR_COMPARE_MODE_SHIFT 20

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_SCALE_OR_COMPARE_MODE(reg) \
    GX_BITGET((reg), 10, 2)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_SCALE_OR_COMPARE_MODE(reg, \
                                                                          x)   \
    ((reg) = GX_BITSET((reg), 10, 2, x))
...
/* raw mask   */ #define GX_BP_TEVCOLORCOMBINER_DEST_MASK                      \
    (((1 << 2) - 1) << 31 - 9)
/* local mask */ #define GX_BP_TEVCOLORCOMBINER_DEST_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_TEVCOLORCOMBINER_DEST_SHIFT 22

/* get value  */ #define GX_BP_GET_TEVCOLORCOMBINER_DEST(reg)                  \
    GX_BITGET((reg), 8, 2)
/* set value  */ #define GX_BP_SET_TEVCOLORCOMBINER_DEST(reg, x)               \
    ((reg) = GX_BITSET((reg), 8, 2, x))
...
/* set value  */ #define GX_BP_SET_TEVREGLO_RED(reg, x)                        \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_TEVREGLO_ALPHA(reg, x)                      \
    ((reg) = GX_BITSET((reg), 9, 11, x))
...
/* set value  */ #define GX_BP_SET_TEVREGLO_TYPE(reg, x)                       \
    ((reg) = GX_BITSET((reg), 8, 1, x))
...
/* set value  */ #define GX_BP_SET_TEVREGHI_BLUE(reg, x)                       \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_TEVREGHI_GREEN(reg, x)                      \
    ((reg) = GX_BITSET((reg), 9, 11, x))
...
/* set value  */ #define GX_BP_SET_TEVREGHI_TYPE(reg, x)                       \
    ((reg) = GX_BITSET((reg), 8, 1, x))
...
/* set value  */ #define GX_BP_SET_FOGRANGE_CENTER(reg, x)                     \
    ((reg) = GX_BITSET((reg), 22, 10, x))
...
/* set value  */ #define GX_BP_SET_FOGRANGE_ENABLED(reg, x)                    \
...
/* set value  */ #define GX_BP_SET_FOGRANGEK_HI(reg, x)                        \
    ((reg) = GX_BITSET((reg), 20, 12, x))
...
/* set value  */ #define GX_BP_SET_FOGRANGEK_LO(reg, x)                        \
    ((reg) = GX_BITSET((reg), 8, 12, x))
...
/* raw mask   */ #define GX_BP_FOGPARAM0_A_MANT_MASK                           \
    (((1 << 11) - 1) << 31 - 31)
/* local mask */ #define GX_BP_FOGPARAM0_A_MANT_LMASK ((1 << 11) - 1)
/* bit shift  */ #define GX_BP_FOGPARAM0_A_MANT_SHIFT 0

/* get value  */ #define GX_BP_GET_FOGPARAM0_A_MANT(reg)                       \
    GX_BITGET((reg), 21, 11)
/* set value  */ #define GX_BP_SET_FOGPARAM0_A_MANT(reg, x)                    \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM0_A_EXP(reg, x)                     \
    ((reg) = GX_BITSET((reg), 13, 8, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM0_A_SIGN(reg, x)                    \
    ((reg) = GX_BITSET((reg), 12, 1, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM1_B_MAG(reg, x)                     \
    ((reg) = GX_BITSET((reg), 8, 24, x))
...
/* raw mask   */ #define GX_BP_FOGPARAM2_B_SHIFT_MASK                          \
    (((1 << 5) - 1) << 31 - 31)
/* local mask */ #define GX_BP_FOGPARAM2_B_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_BP_FOGPARAM2_B_SHIFT_SHIFT 0

/* get value  */ #define GX_BP_GET_FOGPARAM2_B_SHIFT(reg)                      \
    GX_BITGET((reg), 27, 5)
/* set value  */ #define GX_BP_SET_FOGPARAM2_B_SHIFT(reg, x)                   \
...
/* raw mask   */ #define GX_BP_FOGPARAM3_C_MANT_MASK                           \
    (((1 << 11) - 1) << 31 - 31)
/* local mask */ #define GX_BP_FOGPARAM3_C_MANT_LMASK ((1 << 11) - 1)
/* bit shift  */ #define GX_BP_FOGPARAM3_C_MANT_SHIFT 0

/* get value  */ #define GX_BP_GET_FOGPARAM3_C_MANT(reg)                       \
    GX_BITGET((reg), 21, 11)
/* set value  */ #define GX_BP_SET_FOGPARAM3_C_MANT(reg, x)                    \
    ((reg) = GX_BITSET((reg), 21, 11, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM3_C_EXP(reg, x)                     \
    ((reg) = GX_BITSET((reg), 13, 8, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM3_C_SIGN(reg, x)                    \
    ((reg) = GX_BITSET((reg), 12, 1, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM3_PROJ(reg, x)                      \
    ((reg) = GX_BITSET((reg), 11, 1, x))
...
/* set value  */ #define GX_BP_SET_FOGPARAM3_FSEL(reg, x)                      \
    ((reg) = GX_BITSET((reg), 8, 3, x))
...
/* set value  */ #define GX_BP_SET_FOGCOLOR_RGB(reg, x)                        \
    ((reg) = GX_BITSET((reg), 8, 24, x))
...
/* raw mask   */ #define GX_BP_ALPHACOMPARE_REF0_MASK                          \
    (((1 << 8) - 1) << 31 - 31)
/* local mask */ #define GX_BP_ALPHACOMPARE_REF0_LMASK ((1 << 8) - 1)
/* bit shift  */ #define GX_BP_ALPHACOMPARE_REF0_SHIFT 0

/* get value  */ #define GX_BP_GET_ALPHACOMPARE_REF0(reg)                      \
    GX_BITGET((reg), 24, 8)
/* set value  */ #define GX_BP_SET_ALPHACOMPARE_REF0(reg, x)                   \
    ((reg) = GX_BITSET((reg), 24, 8, x))
...
/* raw mask   */ #define GX_BP_ALPHACOMPARE_REF1_MASK                          \
    (((1 << 8) - 1) << 31 - 23)
/* local mask */ #define GX_BP_ALPHACOMPARE_REF1_LMASK ((1 << 8) - 1)
/* bit shift  */ #define GX_BP_ALPHACOMPARE_REF1_SHIFT 8

/* get value  */ #define GX_BP_GET_ALPHACOMPARE_REF1(reg)                      \
    GX_BITGET((reg), 16, 8)
/* set value  */ #define GX_BP_SET_ALPHACOMPARE_REF1(reg, x)                   \
    ((reg) = GX_BITSET((reg), 16, 8, x))
...
/* raw mask   */ #define GX_BP_ALPHACOMPARE_COMP0_MASK                         \
    (((1 << 3) - 1) << 31 - 15)
/* local mask */ #define GX_BP_ALPHACOMPARE_COMP0_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_ALPHACOMPARE_COMP0_SHIFT 16

/* get value  */ #define GX_BP_GET_ALPHACOMPARE_COMP0(reg)                     \
    GX_BITGET((reg), 13, 3)
/* set value  */ #define GX_BP_SET_ALPHACOMPARE_COMP0(reg, x)                  \
    ((reg) = GX_BITSET((reg), 13, 3, x))
...
/* raw mask   */ #define GX_BP_ALPHACOMPARE_COMP1_MASK                         \
    (((1 << 3) - 1) << 31 - 12)
/* local mask */ #define GX_BP_ALPHACOMPARE_COMP1_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_BP_ALPHACOMPARE_COMP1_SHIFT 19

/* get value  */ #define GX_BP_GET_ALPHACOMPARE_COMP1(reg)                     \
    GX_BITGET((reg), 10, 3)
/* set value  */ #define GX_BP_SET_ALPHACOMPARE_COMP1(reg, x)                  \
    ((reg) = GX_BITSET((reg), 10, 3, x))
...
/* raw mask   */ #define GX_BP_ALPHACOMPARE_LOGIC_MASK                         \
    (((1 << 2) - 1) << 31 - 9)
/* local mask */ #define GX_BP_ALPHACOMPARE_LOGIC_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_BP_ALPHACOMPARE_LOGIC_SHIFT 22

/* get value  */ #define GX_BP_GET_ALPHACOMPARE_LOGIC(reg)                     \
    GX_BITGET((reg), 8, 2)
/* set value  */ #define GX_BP_SET_ALPHACOMPARE_LOGIC(reg, x)                  \
    ((reg) = GX_BITSET((reg), 8, 2, x))
...
/* set value  */ #define GX_BP_SET_TEVKSEL_SWAP_RB(reg, x)                     \
    ((reg) = GX_BITSET((reg), 30, 2, x))
...
/* set value  */ #define GX_BP_SET_TEVKSEL_SWAP_GA(reg, x)                     \
    ((reg) = GX_BITSET((reg), 28, 2, x))
...
/* raw mask   */ #define GX_BP_TEVKSEL_KCSEL_EVEN_MASK                         \
    (((1 << 5) - 1) << 31 - 27)
/* local mask */ #define GX_BP_TEVKSEL_KCSEL_EVEN_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_BP_TEVKSEL_KCSEL_EVEN_SHIFT 4

/* get value  */ #define GX_BP_GET_TEVKSEL_KCSEL_EVEN(reg)                     \
    GX_BITGET((reg), 23, 5)
/* set value  */ #define GX_BP_SET_TEVKSEL_KCSEL_EVEN(reg, x)                  \
...
/* raw mask   */ #define GX_BP_TEVKSEL_KASEL_EVEN_MASK                         \
    (((1 << 5) - 1) << 31 - 22)
/* local mask */ #define GX_BP_TEVKSEL_KASEL_EVEN_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_BP_TEVKSEL_KASEL_EVEN_SHIFT 9

/* get value  */ #define GX_BP_GET_TEVKSEL_KASEL_EVEN(reg)                     \
    GX_BITGET((reg), 18, 5)
/* set value  */ #define GX_BP_SET_TEVKSEL_KASEL_EVEN(reg, x)                  \
...
/* raw mask   */ #define GX_BP_TEVKSEL_KCSEL_ODD_MASK                          \
    (((1 << 5) - 1) << 31 - 17)
/* local mask */ #define GX_BP_TEVKSEL_KCSEL_ODD_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_BP_TEVKSEL_KCSEL_ODD_SHIFT 14

/* get value  */ #define GX_BP_GET_TEVKSEL_KCSEL_ODD(reg)                      \
    GX_BITGET((reg), 13, 5)
/* set value  */ #define GX_BP_SET_TEVKSEL_KCSEL_ODD(reg, x)                   \
    ((reg) = GX_BITSET((reg), 13, 5, x))
...
/* raw mask   */ #define GX_BP_TEVKSEL_KASEL_ODD_MASK                          \
    (((1 << 5) - 1) << 31 - 12)
...
/* set value  */ #define GX_BP_SET_TEVKSEL_KASEL_ODD(reg, x)                   \
    ((reg) = GX_BITSET((reg), 8, 5, x))
