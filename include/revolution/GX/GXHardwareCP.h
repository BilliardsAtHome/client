...
/* set value  */ #define GX_CP_SET_MATRIXINDEXA_TEX3(reg, x)                   \
    ((reg) = GX_BITSET((reg), 2, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXA_TEX2_MASK                          \
    (((1 << 6) - 1) << 31 - 13)
...
/* set value  */ #define GX_CP_SET_MATRIXINDEXA_TEX2(reg, x)                   \
    ((reg) = GX_BITSET((reg), 8, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXA_TEX1_MASK                          \
    (((1 << 6) - 1) << 31 - 19)
/* local mask */ #define GX_CP_MATRIXINDEXA_TEX1_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_CP_MATRIXINDEXA_TEX1_SHIFT 12

/* get value  */ #define GX_CP_GET_MATRIXINDEXA_TEX1(reg)                      \
    GX_BITGET((reg), 14, 6)
/* set value  */ #define GX_CP_SET_MATRIXINDEXA_TEX1(reg, x)                   \
    ((reg) = GX_BITSET((reg), 14, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXA_TEX0_MASK                          \
    (((1 << 6) - 1) << 31 - 25)
/* local mask */ #define GX_CP_MATRIXINDEXA_TEX0_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_CP_MATRIXINDEXA_TEX0_SHIFT 6

/* get value  */ #define GX_CP_GET_MATRIXINDEXA_TEX0(reg)                      \
    GX_BITGET((reg), 20, 6)
/* set value  */ #define GX_CP_SET_MATRIXINDEXA_TEX0(reg, x)                   \
    ((reg) = GX_BITSET((reg), 20, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXA_POSNRM_MASK                        \
    (((1 << 6) - 1) << 31 - 31)
/* local mask */ #define GX_CP_MATRIXINDEXA_POSNRM_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_CP_MATRIXINDEXA_POSNRM_SHIFT 0

/* get value  */ #define GX_CP_GET_MATRIXINDEXA_POSNRM(reg)                    \
    GX_BITGET((reg), 26, 6)
/* set value  */ #define GX_CP_SET_MATRIXINDEXA_POSNRM(reg, x)                 \
    ((reg) = GX_BITSET((reg), 26, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXB_TEX7_MASK                          \
    (((1 << 6) - 1) << 31 - 13)
...
/* set value  */ #define GX_CP_SET_MATRIXINDEXB_TEX7(reg, x)                   \
    ((reg) = GX_BITSET((reg), 8, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXB_TEX6_MASK                          \
    (((1 << 6) - 1) << 31 - 19)
/* local mask */ #define GX_CP_MATRIXINDEXB_TEX6_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_CP_MATRIXINDEXB_TEX6_SHIFT 12

/* get value  */ #define GX_CP_GET_MATRIXINDEXB_TEX6(reg)                      \
    GX_BITGET((reg), 14, 6)
/* set value  */ #define GX_CP_SET_MATRIXINDEXB_TEX6(reg, x)                   \
    ((reg) = GX_BITSET((reg), 14, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXB_TEX5_MASK                          \
    (((1 << 6) - 1) << 31 - 25)
/* local mask */ #define GX_CP_MATRIXINDEXB_TEX5_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_CP_MATRIXINDEXB_TEX5_SHIFT 6

/* get value  */ #define GX_CP_GET_MATRIXINDEXB_TEX5(reg)                      \
    GX_BITGET((reg), 20, 6)
/* set value  */ #define GX_CP_SET_MATRIXINDEXB_TEX5(reg, x)                   \
    ((reg) = GX_BITSET((reg), 20, 6, x))
...
/* raw mask   */ #define GX_CP_MATRIXINDEXB_TEX4_MASK                          \
    (((1 << 6) - 1) << 31 - 31)
/* local mask */ #define GX_CP_MATRIXINDEXB_TEX4_LMASK ((1 << 6) - 1)
/* bit shift  */ #define GX_CP_MATRIXINDEXB_TEX4_SHIFT 0

/* get value  */ #define GX_CP_GET_MATRIXINDEXB_TEX4(reg)                      \
    GX_BITGET((reg), 26, 6)
/* set value  */ #define GX_CP_SET_MATRIXINDEXB_TEX4(reg, x)                   \
    ((reg) = GX_BITSET((reg), 26, 6, x))
...
/* set value  */ #define GX_CP_SET_VCD_LO_POSMATIDX(reg, x)                    \
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX0MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 30)
/* local mask */ #define GX_CP_VCD_LO_TEX0MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX0MATIDX_SHIFT 1

/* get value  */ #define GX_CP_GET_VCD_LO_TEX0MATIDX(reg)                      \
    GX_BITGET((reg), 30, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX0MATIDX(reg, x)                   \
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX1MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 29)
/* local mask */ #define GX_CP_VCD_LO_TEX1MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX1MATIDX_SHIFT 2

/* get value  */ #define GX_CP_GET_VCD_LO_TEX1MATIDX(reg)                      \
    GX_BITGET((reg), 29, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX1MATIDX(reg, x)                   \
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX2MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 28)
/* local mask */ #define GX_CP_VCD_LO_TEX2MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX2MATIDX_SHIFT 3

/* get value  */ #define GX_CP_GET_VCD_LO_TEX2MATIDX(reg)                      \
    GX_BITGET((reg), 28, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX2MATIDX(reg, x)                   \
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX3MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 27)
/* local mask */ #define GX_CP_VCD_LO_TEX3MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX3MATIDX_SHIFT 4

/* get value  */ #define GX_CP_GET_VCD_LO_TEX3MATIDX(reg)                      \
    GX_BITGET((reg), 27, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX3MATIDX(reg, x)                   \
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX4MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 26)
/* local mask */ #define GX_CP_VCD_LO_TEX4MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX4MATIDX_SHIFT 5

/* get value  */ #define GX_CP_GET_VCD_LO_TEX4MATIDX(reg)                      \
    GX_BITGET((reg), 26, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX4MATIDX(reg, x)                   \
    ((reg) = GX_BITSET((reg), 26, 1, x))
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX5MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 25)
/* local mask */ #define GX_CP_VCD_LO_TEX5MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX5MATIDX_SHIFT 6

/* get value  */ #define GX_CP_GET_VCD_LO_TEX5MATIDX(reg)                      \
    GX_BITGET((reg), 25, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX5MATIDX(reg, x)                   \
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX6MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 24)
/* local mask */ #define GX_CP_VCD_LO_TEX6MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX6MATIDX_SHIFT 7

/* get value  */ #define GX_CP_GET_VCD_LO_TEX6MATIDX(reg)                      \
    GX_BITGET((reg), 24, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX6MATIDX(reg, x)                   \
    ((reg) = GX_BITSET((reg), 24, 1, x))
...
/* raw mask   */ #define GX_CP_VCD_LO_TEX7MATIDX_MASK                          \
    (((1 << 1) - 1) << 31 - 23)
/* local mask */ #define GX_CP_VCD_LO_TEX7MATIDX_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_TEX7MATIDX_SHIFT 8

/* get value  */ #define GX_CP_GET_VCD_LO_TEX7MATIDX(reg)                      \
    GX_BITGET((reg), 23, 1)
/* set value  */ #define GX_CP_SET_VCD_LO_TEX7MATIDX(reg, x)                   \
...
/* set value  */ #define GX_CP_SET_VCD_LO_POSITION(reg, x)                     \
...
/* set value  */ #define GX_CP_SET_VCD_LO_NORMAL(reg, x)                       \
    ((reg) = GX_BITSET((reg), 19, 2, x))
...
/* raw mask   */ #define GX_CP_VCD_LO_COLORDIFFUSED_MASK                       \
    (((1 << 2) - 1) << 31 - 18)
/* local mask */ #define GX_CP_VCD_LO_COLORDIFFUSED_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_COLORDIFFUSED_SHIFT 13

/* get value  */ #define GX_CP_GET_VCD_LO_COLORDIFFUSED(reg)                   \
    GX_BITGET((reg), 17, 2)
/* set value  */ #define GX_CP_SET_VCD_LO_COLORDIFFUSED(reg, x)                \
...
/* raw mask   */ #define GX_CP_VCD_LO_COLORSPECULAR_MASK                       \
    (((1 << 2) - 1) << 31 - 16)
/* local mask */ #define GX_CP_VCD_LO_COLORSPECULAR_LMASK ((1 << 2) - 1)
/* bit shift  */ #define GX_CP_VCD_LO_COLORSPECULAR_SHIFT 15

/* get value  */ #define GX_CP_GET_VCD_LO_COLORSPECULAR(reg)                   \
    GX_BITGET((reg), 15, 2)
/* set value  */ #define GX_CP_SET_VCD_LO_COLORSPECULAR(reg, x)                \
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX0COORD(reg, x)                    \
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX1COORD(reg, x)                    \
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX2COORD(reg, x)                    \
    ((reg) = GX_BITSET((reg), 26, 2, x))
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX3COORD(reg, x)                    \
    ((reg) = GX_BITSET((reg), 24, 2, x))
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX4COORD(reg, x)                    \
    ((reg) = GX_BITSET((reg), 22, 2, x))
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX5COORD(reg, x)                    \
    ((reg) = GX_BITSET((reg), 20, 2, x))
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX6COORD(reg, x)                    \
    ((reg) = GX_BITSET((reg), 18, 2, x))
...
/* set value  */ #define GX_CP_SET_VCD_HI_TEX7COORD(reg, x)                    \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_POS_CNT_MASK                         \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_CP_VAT_GROUP0_POS_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_POS_CNT_SHIFT 0

/* get value  */ #define GX_CP_GET_VAT_GROUP0_POS_CNT(reg)                     \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_POS_CNT(reg, x)                  \
    ((reg) = GX_BITSET((reg), 31, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_POS_TYPE_MASK                        \
    (((1 << 3) - 1) << 31 - 30)
/* local mask */ #define GX_CP_VAT_GROUP0_POS_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_POS_TYPE_SHIFT 1

/* get value  */ #define GX_CP_GET_VAT_GROUP0_POS_TYPE(reg)                    \
    GX_BITGET((reg), 28, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_POS_TYPE(reg, x)                 \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_POS_SHIFT_MASK                       \
    (((1 << 5) - 1) << 31 - 27)
/* local mask */ #define GX_CP_VAT_GROUP0_POS_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_POS_SHIFT_SHIFT 4

/* get value  */ #define GX_CP_GET_VAT_GROUP0_POS_SHIFT(reg)                   \
    GX_BITGET((reg), 23, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_POS_SHIFT(reg, x)                \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_NRM_CNT_MASK                         \
    (((1 << 1) - 1) << 31 - 22)
/* local mask */ #define GX_CP_VAT_GROUP0_NRM_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_NRM_CNT_SHIFT 9

/* get value  */ #define GX_CP_GET_VAT_GROUP0_NRM_CNT(reg)                     \
    GX_BITGET((reg), 22, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_NRM_CNT(reg, x)                  \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_NRM_TYPE_MASK                        \
    (((1 << 3) - 1) << 31 - 21)
/* local mask */ #define GX_CP_VAT_GROUP0_NRM_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_NRM_TYPE_SHIFT 10

/* get value  */ #define GX_CP_GET_VAT_GROUP0_NRM_TYPE(reg)                    \
    GX_BITGET((reg), 19, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_NRM_TYPE(reg, x)                 \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_COLORDIFF_CNT_MASK                   \
    (((1 << 1) - 1) << 31 - 18)
/* local mask */ #define GX_CP_VAT_GROUP0_COLORDIFF_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_COLORDIFF_CNT_SHIFT 13

/* get value  */ #define GX_CP_GET_VAT_GROUP0_COLORDIFF_CNT(reg)               \
    GX_BITGET((reg), 18, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_COLORDIFF_CNT(reg, x)            \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_COLORDIFF_TYPE_MASK                  \
    (((1 << 3) - 1) << 31 - 17)
/* local mask */ #define GX_CP_VAT_GROUP0_COLORDIFF_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_COLORDIFF_TYPE_SHIFT 14

/* get value  */ #define GX_CP_GET_VAT_GROUP0_COLORDIFF_TYPE(reg)              \
    GX_BITGET((reg), 15, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_COLORDIFF_TYPE(reg, x)           \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_COLORSPEC_CNT_MASK                   \
    (((1 << 1) - 1) << 31 - 14)
/* local mask */ #define GX_CP_VAT_GROUP0_COLORSPEC_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_COLORSPEC_CNT_SHIFT 17

/* get value  */ #define GX_CP_GET_VAT_GROUP0_COLORSPEC_CNT(reg)               \
    GX_BITGET((reg), 14, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_COLORSPEC_CNT(reg, x)            \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_COLORSPEC_TYPE_MASK                  \
    (((1 << 3) - 1) << 31 - 13)
/* local mask */ #define GX_CP_VAT_GROUP0_COLORSPEC_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_COLORSPEC_TYPE_SHIFT 18

/* get value  */ #define GX_CP_GET_VAT_GROUP0_COLORSPEC_TYPE(reg)              \
    GX_BITGET((reg), 11, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_COLORSPEC_TYPE(reg, x)           \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_TXC0_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 10)
/* local mask */ #define GX_CP_VAT_GROUP0_TXC0_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_TXC0_CNT_SHIFT 21

/* get value  */ #define GX_CP_GET_VAT_GROUP0_TXC0_CNT(reg)                    \
    GX_BITGET((reg), 10, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_TXC0_CNT(reg, x)                 \
    ((reg) = GX_BITSET((reg), 10, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_TXC0_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 9)
/* local mask */ #define GX_CP_VAT_GROUP0_TXC0_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_TXC0_TYPE_SHIFT 22

/* get value  */ #define GX_CP_GET_VAT_GROUP0_TXC0_TYPE(reg)                   \
    GX_BITGET((reg), 7, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_TXC0_TYPE(reg, x)                \
    ((reg) = GX_BITSET((reg), 7, 3, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_TXC0_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 6)
/* local mask */ #define GX_CP_VAT_GROUP0_TXC0_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_TXC0_SHIFT_SHIFT 25

/* get value  */ #define GX_CP_GET_VAT_GROUP0_TXC0_SHIFT(reg)                  \
    GX_BITGET((reg), 2, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_TXC0_SHIFT(reg, x)               \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_BYTEDEQUANT_MASK                     \
    (((1 << 1) - 1) << 31 - 1)
/* local mask */ #define GX_CP_VAT_GROUP0_BYTEDEQUANT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_BYTEDEQUANT_SHIFT 30

/* get value  */ #define GX_CP_GET_VAT_GROUP0_BYTEDEQUANT(reg)                 \
    GX_BITGET((reg), 1, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_BYTEDEQUANT(reg, x)              \
...
/* raw mask   */ #define GX_CP_VAT_GROUP0_NORMALINDEX3_MASK                    \
    (((1 << 1) - 1) << 31 - 0)
/* local mask */ #define GX_CP_VAT_GROUP0_NORMALINDEX3_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP0_NORMALINDEX3_SHIFT 31

/* get value  */ #define GX_CP_GET_VAT_GROUP0_NORMALINDEX3(reg)                \
    GX_BITGET((reg), 0, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP0_NORMALINDEX3(reg, x)             \
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC1_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 31)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC1_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC1_CNT_SHIFT 0

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC1_CNT(reg)                    \
    GX_BITGET((reg), 31, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC1_CNT(reg, x)                 \
    ((reg) = GX_BITSET((reg), 31, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC1_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 30)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC1_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC1_TYPE_SHIFT 1

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC1_TYPE(reg)                   \
    GX_BITGET((reg), 28, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC1_TYPE(reg, x)                \
    ((reg) = GX_BITSET((reg), 28, 3, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC1_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 27)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC1_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC1_SHIFT_SHIFT 4

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC1_SHIFT(reg)                  \
    GX_BITGET((reg), 23, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC1_SHIFT(reg, x)               \
    ((reg) = GX_BITSET((reg), 23, 5, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC2_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 22)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC2_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC2_CNT_SHIFT 9

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC2_CNT(reg)                    \
    GX_BITGET((reg), 22, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC2_CNT(reg, x)                 \
    ((reg) = GX_BITSET((reg), 22, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC2_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 21)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC2_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC2_TYPE_SHIFT 10

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC2_TYPE(reg)                   \
    GX_BITGET((reg), 19, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC2_TYPE(reg, x)                \
    ((reg) = GX_BITSET((reg), 19, 3, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC2_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 18)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC2_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC2_SHIFT_SHIFT 13

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC2_SHIFT(reg)                  \
    GX_BITGET((reg), 14, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC2_SHIFT(reg, x)               \
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC3_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 13)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC3_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC3_CNT_SHIFT 18

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC3_CNT(reg)                    \
    GX_BITGET((reg), 13, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC3_CNT(reg, x)                 \
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC3_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 12)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC3_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC3_TYPE_SHIFT 19

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC3_TYPE(reg)                   \
    GX_BITGET((reg), 10, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC3_TYPE(reg, x)                \
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC3_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 9)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC3_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC3_SHIFT_SHIFT 22

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC3_SHIFT(reg)                  \
    GX_BITGET((reg), 5, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC3_SHIFT(reg, x)               \
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC4_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 4)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC4_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC4_CNT_SHIFT 27

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC4_CNT(reg)                    \
    GX_BITGET((reg), 4, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC4_CNT(reg, x)                 \
    ((reg) = GX_BITSET((reg), 4, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP1_TXC4_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 3)
/* local mask */ #define GX_CP_VAT_GROUP1_TXC4_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP1_TXC4_TYPE_SHIFT 28

/* get value  */ #define GX_CP_GET_VAT_GROUP1_TXC4_TYPE(reg)                   \
    GX_BITGET((reg), 1, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP1_TXC4_TYPE(reg, x)                \
    ((reg) = GX_BITSET((reg), 1, 3, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC4_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 31)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC4_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC4_SHIFT_SHIFT 0

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC4_SHIFT(reg)                  \
    GX_BITGET((reg), 27, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC4_SHIFT(reg, x)               \
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC5_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 26)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC5_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC5_CNT_SHIFT 5

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC5_CNT(reg)                    \
    GX_BITGET((reg), 26, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC5_CNT(reg, x)                 \
    ((reg) = GX_BITSET((reg), 26, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC5_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 25)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC5_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC5_TYPE_SHIFT 6

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC5_TYPE(reg)                   \
    GX_BITGET((reg), 23, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC5_TYPE(reg, x)                \
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC5_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 22)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC5_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC5_SHIFT_SHIFT 9

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC5_SHIFT(reg)                  \
    GX_BITGET((reg), 18, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC5_SHIFT(reg, x)               \
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC6_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 17)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC6_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC6_CNT_SHIFT 14

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC6_CNT(reg)                    \
    GX_BITGET((reg), 17, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC6_CNT(reg, x)                 \
    ((reg) = GX_BITSET((reg), 17, 1, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC6_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 16)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC6_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC6_TYPE_SHIFT 15

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC6_TYPE(reg)                   \
    GX_BITGET((reg), 14, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC6_TYPE(reg, x)                \
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC6_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 13)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC6_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC6_SHIFT_SHIFT 18

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC6_SHIFT(reg)                  \
    GX_BITGET((reg), 9, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC6_SHIFT(reg, x)               \
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC7_CNT_MASK                        \
    (((1 << 1) - 1) << 31 - 8)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC7_CNT_LMASK ((1 << 1) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC7_CNT_SHIFT 23

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC7_CNT(reg)                    \
    GX_BITGET((reg), 8, 1)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC7_CNT(reg, x)                 \
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC7_TYPE_MASK                       \
    (((1 << 3) - 1) << 31 - 7)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC7_TYPE_LMASK ((1 << 3) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC7_TYPE_SHIFT 24

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC7_TYPE(reg)                   \
    GX_BITGET((reg), 5, 3)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC7_TYPE(reg, x)                \
    ((reg) = GX_BITSET((reg), 5, 3, x))
...
/* raw mask   */ #define GX_CP_VAT_GROUP2_TXC7_SHIFT_MASK                      \
    (((1 << 5) - 1) << 31 - 4)
/* local mask */ #define GX_CP_VAT_GROUP2_TXC7_SHIFT_LMASK ((1 << 5) - 1)
/* bit shift  */ #define GX_CP_VAT_GROUP2_TXC7_SHIFT_SHIFT 27

/* get value  */ #define GX_CP_GET_VAT_GROUP2_TXC7_SHIFT(reg)                  \
    GX_BITGET((reg), 0, 5)
/* set value  */ #define GX_CP_SET_VAT_GROUP2_TXC7_SHIFT(reg, x)               \
...
/* set value  */ #define GX_CP_SET_ARRAYBASE_BASE(reg, x)                      \
    ((reg) = GX_BITSET((reg), 6, 26, x))
...
/* raw mask   */ #define GX_CP_ARRAYSTRIDE_STRIDE_MASK                         \
    (((1 << 8) - 1) << 31 - 31)
/* local mask */ #define GX_CP_ARRAYSTRIDE_STRIDE_LMASK ((1 << 8) - 1)
/* bit shift  */ #define GX_CP_ARRAYSTRIDE_STRIDE_SHIFT 0

/* get value  */ #define GX_CP_GET_ARRAYSTRIDE_STRIDE(reg)                     \
    GX_BITGET((reg), 24, 8)
/* set value  */ #define GX_CP_SET_ARRAYSTRIDE_STRIDE(reg, x)                  \
