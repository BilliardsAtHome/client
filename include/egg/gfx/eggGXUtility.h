...
public:
    ...
    static void getTexObj(GXTexObj*, nw4r::g3d::ResTex, GXTexWrapMode,
                          GXTexWrapMode, GXTexFilter, GXTexFilter);
    static void set(u16, const nw4r::math::MTX34&, Screen&);
    static void setScreenProjection(bool);

    static void setDrawSetting(u32 setting) {
        sDrawSettings = setting;
    }
