...
public:
    ...
    enum DrawGXFlag { FLAG_INITIALIZE_DISPLAY_LIST = (1 << 0) };
...
public:
    ...
    static void DrawPolygon(const nw4r::math::VEC3&, const nw4r::math::VEC3&,
                            const nw4r::math::VEC3&, GXColor);
    static void BeginDrawShadowVolumeTexture(bool, GXColor, Blend);
    static void ClearEfb(const nw4r::math::MTX34&, bool, bool, bool, GXColor,
                         bool);
    ...
    static DisplayList* GetDisplayList(u32 i) {
        return &s_DL[i];
    }
