...
struct MyItem
{
    ...
    static void SortWithSortSpecs(ImGuiTableSortSpecs* sort_specs, MyItem* items, int items_count)
    {
        ...
        if (items_count > 1)
            ksl::qsort(items, (size_t)items_count, sizeof(items[0]), MyItem::CompareWithSortSpecs);
...
{
    static const ImVec2 pos_norms[] = { ImVec2( 0.0f, 0.0f ), ImVec2( 0.3f, 0.0f ), ImVec2( 0.3f, 0.7f ), ImVec2( 0.7f, 0.7f ), ImVec2( 0.7f, 0.0f ), ImVec2( 1.0f, 0.0f ), ImVec2( 1.0f, 1.0f ), ImVec2( 0.0f, 1.0f ) };
    for (int i = 0; i < IM_ARRAYSIZE(pos_norms); i++)
    {
...
static void NotifyOfDocumentsClosedElsewhere(ExampleAppDocuments& app)
{
    ...
    {
        MyDocument& doc = app.Documents[i];
